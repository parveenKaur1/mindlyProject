...
* DATE REVISED - February 24th 
                 Jui Nagarkar - Add in the remaining 
                 March 9th
                 Jui Nagarkar - Added Incorrect sound
*/
    ...
    return SizedBox(
        ...
        child: Center(
          ...
          if (data == letter) {
            ...
            print('rejected');
            //when the incorrect letter is put in the box, this sound will be played indicating wrong answer
            final player = AudioPlayer();
            player.play(AssetSource('audio/incorrect.wav'));
            return false;
          }
        }, onAccept: (data) {
          accepted = true;
